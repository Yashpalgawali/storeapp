...
public class InvoiceController {
	...
	public String addInvoice(Model model,HttpSession sess)
	{
		...
		if(newtmpid > 0)
		{
//			String tid = sess.getAttribute("temp_id").toString() ;
//			
//			System.out.println("Session ID is -> "+tid);
//			
//			Integer tmid = Integer.parseInt(tid);
//			tilist = tempinserv.getTempInvById(tmid);
			...
			System.out.println("Temp id not null i.e. ID => "+newtmpid);
